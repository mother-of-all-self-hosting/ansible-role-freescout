...
See [the official documentation](https://freescout.apache.org/docs/env/) for a complete list of FreeScout's config options that you can put in `freescout_environment_variables_additional_variables`.
